...
const CartRoutes = () => {
    ...
    fetch(baseUrl, options)
      ...
      .then((updatedCart) => {
        ...
        const updateQTY = (qty) => {
          ...
          updatedQty[i].qty = updatedCart.body.qty;
          return updatedQty;
        };
        const updatedQty = updateQTY(qty);
        setQty(updatedQty);
        setQtyInput(updatedQty.map((el) => el.qty));
  ...
  const changeHandler = (e, i, cartIdHandler) => {
    const qtyTarget = e.target.value.replace(/[^d1-9]/g, ""); // Filter out "-" and "0"
    const newQtyInput =
      qtyTarget === "0" ? qtyInput[i] : parseInt(qtyTarget, 10);
    setQtyInput(newQtyInput);
  ...
  return (
    <div className="block h-[2000px] bg-gray-300">
      ...
      <div className="px-2 flex justify-between items-center bg-white my-4">
        ...
        <div className="flex gap-x-10 py-4 my-3 mr-8 align-center text-slate-600 font-medium">
      ...
      <form onSubmit={submitHandler}>
        ...
        <div className="fixed bottom-0 left-0 w-full bg-white z-10 p-4">
